...
```{r}
satisfaction_per_brand <- read.csv("satisfaction_per_brand.csv")
customerSatisfactionBenchark <- read.csv2("customerSatisfactionBenchmark.csv")
cars_by_fuel_type <- read.csv2("cars_by_fuel_type.csv")
```
